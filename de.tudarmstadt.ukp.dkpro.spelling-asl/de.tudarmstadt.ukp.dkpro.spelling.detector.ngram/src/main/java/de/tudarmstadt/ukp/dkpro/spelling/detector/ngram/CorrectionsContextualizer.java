...
import static de.tudarmstadt.ukp.dkpro.spelling.detector.ngram.LMBasedDetector.BOS;
import static de.tudarmstadt.ukp.dkpro.spelling.detector.ngram.NGramDetectorUtils.getCandidatePosition;
import static de.tudarmstadt.ukp.dkpro.spelling.detector.ngram.NGramDetectorUtils.getTrigram;
        ...
        for (Sentence sentence : JCasUtil.select(jcas, Sentence.class)) {
            ...
            for (SpellingAnomaly anomaly : JCasUtil.selectCovered(jcas, SpellingAnomaly.class, sentence)) {                
                ...
                for (int i=0; i<n; i++) {
                    ...
                    List<String> changedWords = NGramDetectorUtils.getChangedWords(action.getReplacement(), tokenStrings, getCandidatePosition(anomaly, tokens));
                ...
                // add the orginal word as a possibility
