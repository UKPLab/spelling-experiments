...
import static de.tudarmstadt.ukp.dkpro.spelling.experiments.hoo2012.HOO2012Experiments.getNGramProvider;
    ...
    extends UimaTaskBase
{
    ...
    public StatisticalTask(CollectionReaderDescription reader, String targetType, String confusionSetFile, String ngramModel)
    {
        super();
        this.reader = reader;
            ...
            throws ResourceInitializationException, IOException
    {
        ...
        return createAggregateDescription(
                ...
                createPrimitiveDescription(
                        ...
                        FixedCandidateTrigramProbabilityDetector.FREQUENCY_PROVIDER_RESOURCE, getNGramProvider(ngramModel)
                ),
                createPrimitiveDescription(
